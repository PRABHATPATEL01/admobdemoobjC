...
@interface GlobalVendorList (SWIFT_EXTENSION(LRPrivacyManagerSDK))
@end


SWIFT_CLASS("_TtCC19LRPrivacyManagerSDK16GlobalVendorList12DataCategory")
...
SWIFT_CLASS("_TtCC19LRPrivacyManagerSDK16GlobalVendorList3Url")
...
@interface Vendor (SWIFT_EXTENSION(LRPrivacyManagerSDK))
@end


SWIFT_CLASS("_TtCC19LRPrivacyManagerSDK6Vendor13DataRetention")
@interface DataRetention : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
